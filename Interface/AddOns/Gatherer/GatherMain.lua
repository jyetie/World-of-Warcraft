...
Gatherer_RegisterRevision("$URL: http://svn.norganna.org/gatherer/tags/REL_4.3.1/Gatherer/GatherMain.lua $", "$Rev: 967 $")


Gatherer.Var.Version="4.3.1"
