...
L["Installed Modules"] = "설치된 모듈들" -- Needs review
...
L["%sDrag%s to move this button"] = "이 버튼을 옮기려면 %sDrag%s" -- Needs review
...
-- L["Slash Commands:"] = ""
L["%sLeft-Click%s to open the main window"] = "메인 창을 열려면 %sLeft-Click%" -- Needs review
...
L["/tsm help|r - Shows this help listing"] = "/tsm help|r - 이 도움말 목록을 보여줍니다." -- Needs review
-- L["TSM Info / Help"] = ""
L["/tsm|r - opens the main TSM window."] = "/tsm|r - TSM 창을 엽니다." -- Needs review
-- L["Uncommon Gems"] = ""
-- L["Uncommon Inks"] = ""
