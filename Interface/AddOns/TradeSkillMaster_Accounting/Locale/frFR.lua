...
L["MySales Import Complete! Imported %s sales. Was unable to import %s sales."] = "Importation de MySales terminée ! %s ventes importées. Impossible d'importer %s ventes."
L["MySales Import Progress"] = "Importation de Mysales en cours"
L["MySales is currently disabled. Would you like Accounting to enable it and reload your UI so it can transfer settings?"] = "MySales est actuellement désactivé. Souhaitez-vous qu'Accounting l'active et recharge votre interface pour pouvoir transférer les paramètres ?"
L["none"] = "aucun"
L["<none>"] = "<aucun>"
L["Options"] = "Options"
L["Player"] = "Joueur"
...
L["Stack"] = "Pile"
L["Starting to import MySales data. This requires building a large cache of item names which will take about 20-30 seconds. Please be patient."] = "Début de l'importation des données MySales. Cela nécessite la construction d'un important cache de noms d'objets qui prendre environ 20-30 secondes. Merci de patienter."
L["Summary"] = "Résumé"
...
L["TradeSkillMaster_Accounting has detected that you have MySales installed. Would you like to transfer your data over to Accounting?"] = "TradeSkillMaster_Accounting a détecté que MySales est installé. Voulez-vous transférer vos données vers Accounting ?"
