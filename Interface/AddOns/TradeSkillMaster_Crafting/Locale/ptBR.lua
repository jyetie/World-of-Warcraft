...
L["Are you sure you want to delete the selected profile?"] = "Você tem certeza que deseja deletar o perfil selecionado?" -- Needs review
...
L["Can not set a max restock quantity below the minimum restock quantity of %d."] = "Não é possível estabelecer a quantidade de reabastecimento máxima abaixo da quantidade mínima de %d." -- Needs review
...
L["Craft"] = "Produzir"
L["Crafting Cost"] = "Custo de Produção" -- Needs review
...
L["Ink"] = "Tinta"
L["Ink of Dreams"] = "Tinta dos Sonhos" -- Needs review
...
L["Secondary Price Source"] = "Fonte de Preços Secundária" -- Needs review
...
L["Use Lower of Price Sources"] = "Usar o Menor Preço das Fontes" -- Needs review
