...
L["AH/Bags/Bank/Mail/Alts"] = "АУК/Сумки/Банк/Почта/Альты" -- Needs review
L["All"] = "Все"
...
L["Double Click Queue"] = "Добавить предмет(-ов) при двойном клике" -- Needs review
L["Edit Custom Value"] = "Изменить свое значение"
L["Elixir"] = "Эликсир"
L["Enable All Crafts"] = "Выделить все крафты" -- Needs review
...
L["Ignore Vendor Items"] = "Игнорировать товары Торговцев" -- Needs review
L["In Bags"] = "В сумках"
