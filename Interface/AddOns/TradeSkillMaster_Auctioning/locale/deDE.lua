...
L["Cancel Auctions"] = "Abbrechen" -- Needs review
...
L["Items that are stacked beyond the set amount are ignored when calculating the lowest market price."] = "Gegenstände die zu größeren Pakten (Stacks) als das gesetzte Limit gestapelt sind werden bei der Berechnung des niedrigsten Marktpreises ignoriert." -- Needs review
-- L["Items to be added:"] = ""
...
L["Minimum Price Settings (Threshold)"] = "Einstellung für das günstigste Angebot (Preisschwelle)"
-- L["Min Profit:"] = ""
...
L["Name of the new category, this can be whatever you want and has no relation to how the category itself functions."] = "Name der neuen Kategorie, die Sie vollkommen frei benennen können. Der Name hat keinen Bezug auf deren Funktionsweise."
L["Name of the new group, this can be whatever you want and has no relation to how the group itself functions."] = "Name der neuen Gruppe, die Sie vollkommen frei benennen können. Der Name hat keinen Bezug auf deren Funktionsweise."
...
L["Post Auctions"] = "Erstellen"
L["Post cap"] = "Auktionsgrenze" -- Needs review
L["Posting at fallback."] = "Erstelle mit Rückfallpreis."
L["Posting at reset price."] = "Erstelle mit Zurücksetzenpreis."
...
L["Posting %s / %s"] = "Erstelle %s / %s"
L["Posting this item."] = "Stelle diesen Gegenstand ein."
L["Post Scan Finished"] = "Erstellen-Scan abgeschlossen"
L["Post Settings (Quantity / Duration)"] = "Auktionsseinstellungen" -- Needs review
L["Posts items on the auction house according to the rules setup in Auctioning."] = "Stellt die Gegenstände im AH, nach den in \"Auctioning\" eingestellten Regeln, ein."
...
L["Reset Auctions"] = "Zurücksetzen" -- Needs review
...
L["You do not have any players on your blacklist yet."] = "Es befinden sich derzeit keine Spieler auf Ihrer Blacklist." -- Needs review
