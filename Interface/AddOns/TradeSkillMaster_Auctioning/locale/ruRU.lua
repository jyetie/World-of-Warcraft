...
L["If checked, will cancel auctions that can be reposted for a higher amount (ie you haven't been undercut and the auction you originally undercut has expired)."] = "Если выбрано, будут отменены аукционы, которые могут быть перевыставлены за бОльшую сумму (например, вам не сбили цену и аукцион, у которого вы первоначально сбивали цену, истек)."
...
L["Match whitelist prices"] = "Сравнивать с ценой из белого списка"
-- L["Max Cost:"] = ""
...
-- L["Max Quantity:"] = ""
L["Max quantity to buy"] = "Макс. качество для покупки"
L["Max reset cost"] = "Макс. стоимость перепродажи"
...
-- L["Min Profit:"] = ""
L["Min reset profit"] = "Мин. прибыль от перепродажи"
...
L["Price Per Stack"] = "Цена за стопку"
...
L["Reset Auctions"] = "Перепродажа"
L["Reset Method"] = "Метод перепродажи"
L["Reset Profile"] = "Сброс профиля"
L["Reset Scan Finished"] = "Сканирование лотов на перепродажу завершено"
L["Reset Scan Settings"] = "Настройка перепродажи лотов"
...
L["Right click to do a custom cancel scan."] = "ПКМ, чтобы выполнить выборочный скан на отмену"
L["Right click to do a custom post scan."] = "ПКМ, чтобы выполнить выборочный скан выставления"
L["Right click to do a custom reset scan."] = "ПКМ, чтобы выполнить выборочный скан на перепродажу"
...
L["Short (30 minutes)"] = "Короткий (30 минут)"
